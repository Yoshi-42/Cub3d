...
{
	if (vars->m_map.p_imgs[0] != NULL && vars->m_map.imgN.img != NULL)
		mlx_destroy_image(vars->mlx, vars->m_map.imgN.img);
	if (vars->m_map.p_imgs[0] != NULL && vars->m_map.imgS.img != NULL)
		mlx_destroy_image(vars->mlx, vars->m_map.imgS.img);
	if (vars->m_map.p_imgs[0] != NULL && vars->m_map.imgO.img != NULL)
		mlx_destroy_image(vars->mlx, vars->m_map.imgO.img);
	if (vars->m_map.p_imgs[0] != NULL && vars->m_map.imgE.img != NULL)
		mlx_destroy_image(vars->mlx, vars->m_map.imgE.img);
	if (vars->m_map.p_imgs[0] != NULL && vars->img->img != NULL)
